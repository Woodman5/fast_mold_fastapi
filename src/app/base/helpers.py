...
from typing import TYPE_CHECKING, Any, Dict, List, Optional, Tuple, Type, cast, Callable
...
# def get_annotations(cls: "Type[Base]", method: Optional[Callable] = None) -> Dict[str, Any]:
#     """
...
class PydanticModel(pydantic.BaseModel):
    ...
    @classmethod
    async def from_tortoise_orm(cls, obj: "Base") -> "PydanticModel":
        """
...
def pydantic_model_creator(
    ...
    *,
    ...
    for fname, fdesc in field_map.items():
        ...
        if (
            field_type is ForeignKey
            or field_type is relationship
        ):
